...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"product-link-maker/rakuten","version":"0.1.0","title":"楽天商品リンク","category":"product-link-maker","icon":"cart","description":"楽天商品のアフィリエイトリンクを表示するブロックです。","example":{"attributes":{"id":"book:11830886","kw":"サンプル商品","title":"サンプル商品タイトル","price":"1,980","imageUrl":"https://placehold.co/300x300/e8e8e8/666?text=Product+Image","desc":"商品の説明文をここに入力できます","shopName":"楽天ブックス","showShop":true,"showRakuten":true,"showAmazon":true,"showYahoo":true,"showMercari":true,"showDmm":true}},"supports":{"html":false},"textdomain":"product-link-maker","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScript":"file:./view.js","attributes":{"id":{"type":"string","default":""},"no":{"type":"string","default":""},"kw":{"type":"string","default":""},"shop":{"type":"string","default":""},"search":{"type":"string","default":""},"title":{"type":"string","default":""},"price":{"type":"boolean","default":false},"showShop":{"type":"boolean","default":true},"desc":{"type":"string","default":""},"imageUrl":{"type":"string","default":""},"showImage":{"type":"boolean","default":true},"showAmazon":{"type":"boolean","default":true},"showRakuten":{"type":"boolean","default":true},"showYahoo":{"type":"boolean","default":true},"showMercari":{"type":"boolean","default":true},"showDmm":{"type":"boolean","default":true},"customButtonsBefore":{"type":"array","default":[]},"customButtonsAfter":{"type":"array","default":[]}}}');
  ...
  const fetchData = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useCallback)(async () => {
    ...
    try {
      ...
      if (data && data.Items && data.Items.length > 0 && data.Items[0]?.Item) {
        ...
        setAttributes(prev => {
          const hasCustomImage = prev.imageUrl && prev.imageUrl !== '' && !prev.imageUrl.includes('thumbnail.image.rakuten.co.jp');
          return {
            ...prev,
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarGroup, {
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Dropdown, {
          popoverProps: {
          ...
          renderToggle: ({
            ...
            icon: "admin-settings",
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('表示設定', 'product-link-maker'),
            onClick: onToggle,
            "aria-expanded": isOpen
          }),
          renderContent: () => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.MenuGroup, {
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.MenuItem, {
              ...
              children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('商品画像を表示', 'product-link-maker')
              ...
              onClick: () => setAttributes({
                showAmazon: !attributes.showAmazon
              }),
              children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Amazonボタンを表示', 'product-link-maker')
            }), settings.rakuten && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.MenuItem, {
              icon: attributes.showRakuten !== false ? 'yes' : undefined,
              isSelected: attributes.showRakuten !== false,
              onClick: () => setAttributes({
                showRakuten: !attributes.showRakuten
              }),
              children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('楽天ボタンを表示', 'product-link-maker')
            }), settings.yahoo && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.MenuItem, {
              icon: attributes.showYahoo !== false ? 'yes' : undefined,
              isSelected: attributes.showYahoo !== false,
              onClick: () => setAttributes({
                showYahoo: !attributes.showYahoo
              }),
              children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Yahoo!ボタンを表示', 'product-link-maker')
            }), settings.mercari && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.MenuItem, {
              icon: attributes.showMercari !== false ? 'yes' : undefined,
              isSelected: attributes.showMercari !== false,
              onClick: () => setAttributes({
                showMercari: !attributes.showMercari
              }),
              children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('メルカリボタンを表示', 'product-link-maker')
            }), settings.dmm && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.MenuItem, {
              icon: attributes.showDmm !== false ? 'yes' : undefined,
              isSelected: attributes.showDmm !== false,
              onClick: () => setAttributes({
                showDmm: !attributes.showDmm
              }),
              children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('DMMボタンを表示', 'product-link-maker')
            })]
          })
        })
      })
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        ...
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('商品画像', 'product-link-maker'),
        initialOpen: true,
            ...
            children: [(attributes.imageUrl !== '' ? attributes.imageUrl : item?.mediumImageUrls?.[0]?.imageUrl) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
              ...
              render: ({
                ...
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
                  ...
                  variant: "secondary",
                  children: "\u753B\u50CF\u3092\u9078\u629E"
                }), attributes.imageUrl && attributes.imageUrl !== '' && attributes.imageUrl !== item?.mediumImageUrls?.[0]?.imageUrl && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
                  style: {
                    marginTop: 4
                  },
                  onClick: () => setAttributes({
        ...
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('API設定', 'product-link-maker'),
        initialOpen: false,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
          ...
          children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('アフィリエイト設定を開く', 'product-link-maker')
        })
      })]
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
